...
const TrainList = () => {
  ...
  {/* <button class="btn btn-lg btn-primary btn-block text-uppercase" onclick={()=>{<Link to="/login"></Link>

  }}>Logout</button> */}
  <Link className="btn btn-lg btn-primary btn-block text-uppercase" to={"./login"}>
                        Logout </Link>
  { 
